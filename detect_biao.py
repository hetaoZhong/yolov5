...
def run(weights=ROOT / 'yolov5s.pt',  # model.pt path(s)
        ...
        name='my_biao',  # save results to project/name
...
def parse_opt(uname):
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/my_biao_0/weights/best.pt',help='model path(s)')
    ...
    parser.add_argument('--name', default='detect_biao', help='save results to project/name')
