...
def run(weights=ROOT / 'yolov5s.pt',  # model.pt path(s)
        ...
        name='my_stl_transfer',  # save results to project/name
...
def parse_opt(uname):
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/my_stl_transfer_0/weights/best.pt',help='model path(s)')
