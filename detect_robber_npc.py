...
def run(weights=ROOT / 'yolov5s.pt',  # model.pt path(s)
        ...
        name='my_robber_npc',  # save results to project/name
...
def parse_opt(uname):
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/my_robber_1/weights/best.pt',help='model path(s)')
    ...
    parser.add_argument('--name', default='detect_robber_npc', help='save results to project/name')
