...
def run(weights=ROOT / 'yolov5s.pt',  # model.pt path(s)
        ...
        name='my_face',  # save results to project/name
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        if 0 == c and conf.float() > detect_rate:
...
>>>>>>> 9c93cb8ca379306e9eed48732f84da561ba83dc2
    # Print results
...
def parse_opt(uname, weight_path):
    ...
    parser.add_argument('--source', type=str, default='D:\\YOLO_TEMP_FILE\\' + uname,
    ...
    parser.add_argument('--name', default='detect_face', help='save results to project/name')
